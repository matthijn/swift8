...
class Theme // A struct is more appropriate, but to store it in the NSUserDefaults settings it must be an object
{
...
class Themes
{
    ...
    static let availableThemes = [
        Theme(name: "Classic", backgroundColor: NSColor.blackColor(), foregroundColor: NSColor.whiteColor()),
        ...
        Theme(name: "Tangerine", backgroundColor: NSColor(calibratedRed: 0.69, green: 0.37, blue: 0, alpha: 1), foregroundColor: NSColor(calibratedRed: 1, green: 0.77, blue: 0, alpha: 1))
    ]
