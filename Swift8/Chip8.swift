...
class Chip8
{
    ...
    lazy var mapping : [UInt16: ((UInt16) -> Void)] = {
        ...
        return [
            ...
            0x3000: { arg in
                let register = Int(arg & 0x0100)
                let value = UInt8(arg & 0x0011)
            ...
            0xB000: { arg in
                let value0 = self.V[0];
                self.pc = UInt16(value0) + (arg & 0x0111)
            },
            ...
            0xD000: { arg in
                ...
                let spriteSize = UInt16(arg & 0x0001)
